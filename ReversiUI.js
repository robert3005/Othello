...
<<<<<<< HEAD
	var ReversiUI = function () {
			...
			this.drawBoard = function () {
				...
				this.drawable = Raphael("othello", this.gridsize, this.gridsize);
				this.header = this.drawable.text(this.gridsize / 2, 50).attr({
					font: "bold 40px Verdana",
					fill: this.blacks,
					text: "Blacks Turn"
				});
				...
				var shiftColours = function(colour) {
					return function() {
						this.animate({fill: colour}, 200, "backOut");
					}
				}
				var newGame = this.drawable.text(80, 610, "Restart").attr({
					font: "bold 32px Verdana",
					fill: this.blacks
				}).click(this.playAgain(this)).hover(shiftColours(this.boardColorDark),shiftColours(this.blacks));
				var path = "M0 " + 92 + " L" + this.gridsize + " " + 92;
				var separator = this.drawable.path(path);
				var path2 = "M0 " + 635 + " L" + this.gridsize + " " + 635;
				var separator2 = this.drawable.path(path2);
...
=======
    ...
    UI.initialise();
    UI.drawBoard();
>>>>>>> 24abadfb773278353f975442f610f28d8f3b64d8
};